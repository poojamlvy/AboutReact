...
import myImage from './images/hall.jpg';
import myImage1 from './images/med.jpg';
import myImage2 from './images/Prabh.jpg';
import myImage3 from './images/dom.jpg';
import myImage4 from './images/pooja.jpg';
            ...
            <div className="row">
              <div className="col-md-3 profile text-center">
                <div className="img-box">
                  <img src={myImage1} className="img-responsive" alt="" />
                  <ul>
                    <a href="#">
              ...
              <div className="col-md-3 profile text-center">
                <div className="img-box">
                  <img src={myImage2} className="img-responsive" alt="" />
                  <ul>
                    <a href="#">
                      <li><i className="fa-brands fa-facebook-f" /></li>
                    </a>
              ...
              <div className="col-md-3 profile text-center">
                <div className="img-box">
                  <img src={myImage3}className="img-responsive" alt="" />
                  <ul>
                    <a href="#">
                      <li><i className="fa-brands fa-facebook-f" /></li>
                    </a>
              ...
              <div className="col-md-3 profile text-center">
                <div className="img-box">
                  <img src={myImage4} className="img-responsive" alt="" />
                  <ul>
                    <a href="#">
                      <li><i className="fa-brands fa-facebook-f" /></li>
                    </a>
